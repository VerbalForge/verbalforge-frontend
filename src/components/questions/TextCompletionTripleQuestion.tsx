...
export function TextCompletionTripleQuestion({
  ...
  const handleSubmit = async () => {
    ...
    const choice3 = findChoiceByOption(question.choices, option3, 3);
  ...
  const blank3Correct = isSubmitted && selectedBlank3 !== null
    ? findChoiceByOption(question.choices, shuffledBlank3[selectedBlank3].option, 3)?.is_correct || false
    : false;
      ...
      <div className="space-y-1.5">
        ...
        <div className="grid grid-cols-3 gap-x-3 gap-y-1.5">
          ...
          <OptionButton
            ...
            choice={findChoiceByOption(question.choices, shuffledBlank3[0].option, 3) || null}
            isSelected={selectedBlank3 === 0}
            isCorrect={findChoiceByOption(question.choices, shuffledBlank3[0].option, 3)?.is_correct || false}
            isSubmitted={isSubmitted}
          ...
          <OptionButton
            ...
            choice={findChoiceByOption(question.choices, shuffledBlank3[1].option, 3) || null}
            isSelected={selectedBlank3 === 1}
            isCorrect={findChoiceByOption(question.choices, shuffledBlank3[1].option, 3)?.is_correct || false}
            isSubmitted={isSubmitted}
          ...
          <OptionButton
            ...
            choice={findChoiceByOption(question.choices, shuffledBlank3[2].option, 3) || null}
            isSelected={selectedBlank3 === 2}
            isCorrect={findChoiceByOption(question.choices, shuffledBlank3[2].option, 3)?.is_correct || false}
            isSubmitted={isSubmitted}
